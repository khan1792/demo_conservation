...
st.write('It is worth noting that we used machine learning techinqiues to disambuate funder information because it was messay in the raw data, as well as to identify research topics of every paper and to predict funder type. The results are not 100% accurate.')
